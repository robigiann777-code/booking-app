      ...
      <div className="bg-white border-b border-gray-200 px-4 py-3 shadow-sm">
        <div className="flex justify-between items-center">
          ...
          <div className="flex gap-2">
            ...
            <button onClick={logout} className="text-gray-500 text-xs px-3 py-2 rounded-xl border border-gray-200"><button onClick={() => router.push('/admin')} className="bg-gray-100 text-gray-700 text-xs px-3 py-2 rounded-xl font-medium border border-gray-200">👑</button>Esci</button>
          </div>
        </div>
      </div>
